...
cp AMD/Lib/libamd.a UMFPACK/Lib
...
#export MPI_BASE_DIR=/usr/local/mpi/32Bit/1.2.7/gcc-3.4.3
...
#export MPI_BASE_DIR=/home/extras/mpi/mpich-1.2.7p1-gcc-4.2.4-64Bit

#FORTRAN_COMPILER=/home/extras/compilers/gcc-4.2.4/bin/gfortran
...
-D LAPACK_LIBRARY_NAMES="lapack_LINUX.a" \
-D BLAS_LIBRARY_DIRS=$GOMA_LIB/BLAS \
-D BLAS_LIBRARY_NAMES="blas_LINUX.a" \
...
-D TPL_ENABLE_UMFPACK:BOOL=ON \
  ...
  -D UMFPACK_LIBRARY_DIRS:PATH=$GOMA_LIB/UMFPACK-5.4/UMFPACK/Lib \
  -D UMFPACK_INCLUDE_DIRS:PATH=$GOMA_LIB/UMFPACK-5.4/UMFPACK/Include \
-D TPL_ENABLE_AMD:BOOL=ON \
  -D AMD_LIBRARY_NAMES:STRING="amd" \
  -D AMD_LIBRARY_DIRS:PATH=$GOMA_LIB/UMFPACK-5.4/AMD/Lib \
  -D AMD_INCLUDE_DIRS:PATH=$GOMA_LIB/UMFPACK-5.4/AMD/Include \
